...
class TextModel(models.Model): 
    ...
    pay_btn = models.CharField(max_length=128 , default='خرید' , verbose_name='دکمه خرید و رفتن به درگاه')
    invite_btn = models.CharField(max_length=128 , verbose_name='دکمه دعوت دوستان' , default='none')
    ...
    back_btn= models.CharField(max_length=128 , default='back' , verbose_name='دکمه بازگشت')
